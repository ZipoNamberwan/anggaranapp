		...
		<div class="wrapper  pa-0">
			<header class="sp-header">
				<div class="sp-logo-wrap pull-left">
					<a href="index.html">
						<img class="brand-img mr-10" src="/img/bpsntt2.png" alt="brand"/>
							...
							<div class="auth-form  ml-auto mr-auto no-float card-view pt-30 pb-30">
								<div class="row">
									<div class="col-sm-12 col-xs-12">
										<div class="mb-30">
											<h3 class="text-center txt-dark mb-10">Login Aplikasi Anggaran</h3>
											<h6 class="text-center nonecase-font txt-grey">Masukkan username dan password</h6>
										</div>	
										<div class="form-wrap">
											<form action="/dashboard">
												<div class="form-group">
													<label class="control-label mb-10" for="exampleInputText">Username</label>
													<input type="text" class="form-control" required="" id="exampleInputText" placeholder="Enter email">
												</div>
												<div class="form-group">
