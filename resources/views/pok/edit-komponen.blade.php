                    ...
                    <div class="panel-body">
                        <form autocomplete="off" onsubmit="return onSubmit()" action="/pok/{{$type}}/{{$pokitem->id}}" data-toggle="validator" role="form" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Kode Komponen" name="id" value="{{old('id', $pokitem->kode)}}">
                                @error('id')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Deskripsi Komponen" name="name" value="{{old('name', $pokitem->deskripsi)}}">
                                @error('name')
                                <div class="mt-10"><span class="text-danger">{{$message}}</span></div>
                                @enderror
                            </div>
