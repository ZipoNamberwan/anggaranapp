        ...
        <div class="col-sm-12">
            <div class="panel panel-default border-panel card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Tambah KRO</h6>
                    </div>
                    ...
                    <div class="panel-body">
                        <form autocomplete="off" onsubmit="return onSubmit()" action="/pok" data-toggle="validator" role="form" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{$parent->program->kode}} {{$parent->program->deskripsi}}" disabled>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Kode KRO" name="id" value="{{old('id')}}">
                                @error('id')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Deskripsi KRO" name="name"  value="{{old('name')}}">
                                @error('name')
                                <div class="mt-10"><span class="text-danger">{{$message}}</span></div>
                                @enderror
                            </div>
