            ...
            <div class="panel panel-default border-panel card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        ...
                        <p class="mb-0"><small>Menu Ubah Posisi digunakan untuk mengubah urutan Jenis Produk</small></p>
                        <p class="mb-0"><small>*Gunakan icon <i class="fa fa-arrows"></i> untuk mengubah posisi Jenis Produk dengan teknik Drag and Drop</small></p>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <form autocomplete="off" method="post" action="#" class="needs-validation ml-3" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="row">
                                <!-- <div class="container">
                                ...
                                <div class="container">
                                    ...
                                    <div id="sortablelist" class="list-group">
                                        @foreach($pokitems as $pokitem)
                                        <div class="list-group-item px-0 handle" style="border: none" draggable="false">
