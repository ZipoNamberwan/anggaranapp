        ...
        <div class="col-sm-12">
            <div class="panel panel-default border-panel card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Ubah Aktivitas</h6>
                    </div>
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <form autocomplete="off" onsubmit="return onSubmit()" action="/pok/{{$type}}/{{$pokitem->kode}}" data-toggle="validator" role="form" method="POST">
                            ...
                            <div class="form-group">
                                <label class="control-label mb-10 text-left">Deskripsi Aktivitas</label>
                                <input type="text" class="form-control" placeholder="Deskripsi Aktivitas" name="name" value="{{old('name', $pokitem->deskripsi)}}">
                                @error('name')
                                <div class="mt-10"><span class="text-danger">{{$message}}</span></div>
                                @enderror
                            </div>
                            ...
                            <input type="hidden" value="aktivitas" name="create_type">
