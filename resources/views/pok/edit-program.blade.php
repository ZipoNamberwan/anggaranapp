        ...
        <div class="col-sm-12">
            <div class="panel panel-default border-panel card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Ubah Program</h6>
                    </div>
                    ...
                    <div class="panel-body">
                        <form autocomplete="off" onsubmit="return onSubmit()" action="/pok/{{$type}}/{{$pokitem->kode}}" data-toggle="validator" role="form" method="POST">
                            ...
                            <div class="form-group">
                                <label class="control-label mb-10 text-left">Kode Program</label>
                                <input type="text" class="form-control" placeholder="Kode Program" name="id" value="{{old('id', $pokitem->kode)}}">
                                @error('id')
                                <div class="mt-10"><span class="text-danger">{{$message}}</span></div>
                                @enderror
                            </div>
                            <div class="form-group">
                                <label class="control-label mb-10 text-left">Deskripsi Program</label>
                                <input type="text" class="form-control" placeholder="Deskripsi Program" name="name" value="{{old('name', $pokitem->deskripsi)}}">
                                @error('name')
                                <div class="mt-10"><span class="text-danger">{{$message}}</span></div>
                                @enderror
                            </div>
                            ...
                            <input type="hidden" value="program" name="create_type">
