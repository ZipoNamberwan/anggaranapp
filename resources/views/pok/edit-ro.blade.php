        ...
        <div class="col-sm-12">
            <div class="panel panel-default border-panel card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Ubah RO</h6>
                    </div>
                    ...
                    <div class="panel-body">
                        <form autocomplete="off" onsubmit="return onSubmit()" action="/pok/{{$type}}/{{$pokitem->kode}}" data-toggle="validator" role="form" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{$pokitem->kro->aktivitas->program->kode}} {{$pokitem->kro->aktivitas->program->deskripsi}}" disabled>
                            </div>
                            <div class="form-group">
                                <label class="control-label mb-10 text-left">Aktivitas</label>
                                <input type="text" class="form-control" value="{{$pokitem->kro->aktivitas->kode}} {{$pokitem->kro->aktivitas->deskripsi}}" disabled>
                            </div>
                            <div class="form-group">
                                <label class="control-label mb-10 text-left">KRO</label>
                                <input type="text" class="form-control" value="{{$pokitem->kro->kode}} {{$pokitem->kro->deskripsi}}" disabled>
                            </div>
                            <div class="form-group">
                                <label class="control-label mb-10 text-left">Kode RO</label>
                                <input type="text" class="form-control" placeholder="Kode Aktivitas" name="id" value="{{old('id', $pokitem->kode)}}">
                                @error('id')
                                <div class="mt-10"><span class="text-danger">{{$message}}</span></div>
                                @enderror
                            </div>
                            <div class="form-group">
                                <label class="control-label mb-10 text-left">Deksripsi RO</label>
                                <input type="text" class="form-control" placeholder="Deskripsi" name="name" value="{{old('name', $pokitem->deskripsi)}}">
                                @error('name')
                                <div class="mt-10"><span class="text-danger">{{$message}}</span></div>
                                @enderror
                            </div>
                            ...
                            <input type="hidden" value="ro" name="create_type">
