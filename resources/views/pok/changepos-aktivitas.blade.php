        ...
        <div class="col-sm-12">
            <div class="panel panel-default border-panel card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h2 class="panel-title txt-dark">Ubah Posisi Aktivitas</h2>
                        <p class="mb-0"><small>Menu Ubah Posisi digunakan untuk mengubah urutan Aktivitas</small></p>
                        <p class="mb-0"><small>*Gunakan icon <i class="fa fa-arrows"></i> untuk mengubah posisi Aktivitas dengan teknik Drag and Drop</small></p>
                    </div>
                    ...
                    <div class="panel-body">
                        <form autocomplete="off" method="post" action="/pok/changepos/{{$type}}/id/{{$id}}" class="needs-validation ml-3" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="form-group">
                                <label class="control-label mb-10 text-left"><strong>Deskripsi Program</strong></label>
                            ...
                            <div class="row container" style="display: flex;">
                                ...
                                <div class="container">
                                    <strong class="mb-0">Deksripsi Aktivitas</strong>
